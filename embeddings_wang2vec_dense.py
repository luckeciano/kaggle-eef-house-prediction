...
filepath="best-models/wang2vec_s600_best_dense"
...
y_lb = np.expm1(model.predict(X_test, batch_size=2048))

print (id_lb)
res = np.hstack([id_lb, y_lb])
np.savetxt('feature-embeddings/wang2vec_dense_features.csv', res, delimiter=',', fmt=['%d', '%.10f'])
